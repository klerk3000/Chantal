...
class TasksController: UITableViewController {
    ...
    @IBAction func addTask(_ sender: UIBarButtonItem) {
        ...
        alertController.addTextField { textField in
            ...
            let usslesButton = UIAlertAction(title: "Картинка", style: .destructive) {_ in
                print("da")
                let imageView = UIImageView(image: UIImage(named: "delete"))
                    ...
                    imageView.center = imageViewController.view.center

                    self.present(imageViewController, animated: true, completion: nil)
            
        }
        alertController.addAction(usslesButton)
